...
public class TeamDeathMatchBreakPanel : Photon.PunBehaviour {
    ...
    private void SetupScore() {
        redScore.text = Localisation.GetString("Score") + " " + gameManager.RedTeamScore;
        blueScore.text = Localisation.GetString("Score") + " " + gameManager.BlueTeamScore;
    }
